...
public class Array {
    public static void main(String[] args) {
        System.out.print("Ввести количество элементов массива: ");
        ...
        System.out.println("\nВыбрать, что нужно сделать с массивом:" +
        ...
        switch (sw) {
            ...
            case 2:
                ...
                break;
            case 3:
                System.out.print("\nВвести число, которое нужно найти: ");
                int item = in.nextInt();
                searchInArray(arr, item);
                break;
            case 4:
                System.out.println("Ввести элемент для бинарного поиска: ");
                item = in.nextInt();
                int first = 0;
    ...
    public static void binarySearch(int[] array, int first, int last, int item) {
        ...
        if (first <= last) {
            ...
            System.out.println("Методом бинарного поиска было найдено число после " + comparisonCount +
                    " сравнений");
        } else {
